...
export class SaintPatrickCardService {
  ...
  async create(createSaintPatrickCardDto: CreateSaintPatrickCardDto): Promise<SaintPatrickCard> {
    ...
    const saintPatrickCard = this.saintPatrickCardRepository.create(rest);
  ...
  async findOne(id: number): Promise<SaintPatrickCard> {
    const saintPatrickCard = await this.saintPatrickCardRepository.findOne({ where: { id }, relations: ['wallet'] });
    if (!saintPatrickCard) {
  ...
  async update(id: number, updateSaintPatrickCardDto: UpdateSaintPatrickCardDto): Promise<SaintPatrickCard> {
